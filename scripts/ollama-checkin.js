...
function handleDecision(decision) {
  switch (decision) {
    ...
    case 'n':
      ...
      log(
        '   ',
        'Address the concerns raised in the improvements section',
        'red',
      )
      return 2
    default:
...
async function main() {
  ...
  if (!taskSummary) {
    ...
    console.error(
      'Example: node scripts/ollama-checkin.js "Fixed all typescript-eslint errors in 5 files"',
    )
    process.exit(1)
  }
