...
class TestEnhancedSearchResult:
    ...
    def test_enhanced_search_result_creation(self):
        ...
        knowledge_item = KnowledgeItem(
            id="test_item",
            content="Test content about depression",
            knowledge_type="dsm5"
        )
...
class TestClinicalSimilaritySearch:
    ...
    def test_calculate_clinical_relevance(self):
        ...
        relevance_score, explanation = search_system._calculate_clinical_relevance(knowledge_item, query)
    ...
    def test_combine_scores_different_contexts(self):
        ...
        training_score = search_system._combine_scores(similarity_score, relevance_score, SearchContext.TRAINING)
        inference_score = search_system._combine_scores(similarity_score, relevance_score, SearchContext.INFERENCE)
        validation_score = search_system._combine_scores(similarity_score, relevance_score, SearchContext.VALIDATION)
        research_score = search_system._combine_scores(similarity_score, relevance_score, SearchContext.RESEARCH)
        ...
        assert training_score < validation_score  # Training prioritizes relevance, validation prioritizes similarity
