...
def test_retrieval_files_exist():
    ...
    retrieval_file = Path(__file__).parent.parent / "ai" / "pixel" / "data" / "realtime_knowledge_retrieval.py"
    test_file = Path(__file__).parent.parent / "ai" / "pixel" / "data" / "test_realtime_knowledge_retrieval.py"
