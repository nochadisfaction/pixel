...
import type { SessionData, BiasAnalysisResults } from '../../../../lib/types/bias-detection'
...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    const counterfactualScenarios = generateCounterfactualScenarios(sessionData, biasFactors)
    const historicalComparison = generateHistoricalComparison(biasFactors.overall)
    const recommendations = generateRecommendations(biasFactors, sessionData.demographics)
    ...
    console.log(`Bias analysis completed for session ${sessionData.sessionId}:`, {
