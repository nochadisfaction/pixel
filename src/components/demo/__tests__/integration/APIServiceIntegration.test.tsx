...
describe('API Service Integration Tests', () => {
  ...
  describe('Training Pipeline APIs', () => {
    ...
    describe('MLflow Tracking Integration', () => {
      it('creates experiment in MLflow', async () => {
        ...
        const response = await fetch('http://mlflow.company.com/api/2.0/mlflow/experiments/create', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
      ...
      it('logs metrics to MLflow', async () => {
        ...
        const response = await fetch('http://mlflow.company.com/api/2.0/mlflow/runs/log-batch', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    describe('Azure ML Integration', () => {
      it('creates Azure ML dataset', async () => {
        ...
        const response = await fetch('https://ml.azure.com/api/workspaces/ws-123/datasets', {
          method: 'PUT',
          headers: { 
  ...
  describe('Real-time WebSocket Connections', () => {
    it('establishes WebSocket connection for real-time updates', async () => {
      ...
      expect(WebSocket).toHaveBeenCalledWith('ws://localhost:3000/pipeline-updates');
