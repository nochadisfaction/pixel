...
const PresentingProblemVisualization: React.FC<PresentingProblemVisualizationProps> = ({
  events,
  presentingProblem
}) => {
  ...
  return (
    <div className="presenting-problem-visualization bg-white rounded-lg p-6 border shadow-sm">
      ...
      <div className="mb-6 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-400">
        <h5 className="font-medium text-blue-800 mb-2">Current Presenting Problem</h5>
      ...
      {sortedEvents.length > 0 && (
        <div className="relative">
          <h5 className="font-medium text-gray-700 mb-4">Problem Development History</h5>
          ...
          <div className="mt-6 p-3 bg-gray-50 rounded-lg">
            <h6 className="text-sm font-medium text-gray-700 mb-2">Severity Progression</h6>
          ...
          <div className="mt-4 p-3 bg-indigo-50 rounded-lg">
            <h6 className="text-sm font-medium text-indigo-800 mb-2">Clinical Insights</h6>
            <div className="text-xs text-indigo-700 space-y-1">
              <p>• <strong>Duration:</strong> Problem has been developing over {sortedEvents.length} documented stages</p>
              ...
              <p>• <strong>Intervention Window:</strong> {
                sortedEvents.length <= 2 
