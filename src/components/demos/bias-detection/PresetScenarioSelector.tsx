...
export const PresetScenarioSelector: React.FC<PresetScenarioSelectorProps> = ({
  ...
  const [previewScenario, setPreviewScenario] = useState<PresetScenario | null>(null)
          ...
          >
            ...
            <div className="flex items-start justify-between mb-2">
              ...
              <div className="flex space-x-2">
                ...
                <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getRiskLevelStyle(scenario.riskLevel)}`}>
                  {scenario.riskLevel}
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-3">
              <div className="text-xs">
                ...
                <span className="ml-1 font-medium">{scenario.demographics.age}</span>
              </div>
              <div className="text-xs">
                <span className="text-gray-500">Gender:</span>
                <span className="ml-1 font-medium">{scenario.demographics.gender}</span>
              </div>
              <div className="text-xs">
                <span className="text-gray-500">Ethnicity:</span>
                <span className="ml-1 font-medium">{scenario.demographics.ethnicity}</span>
              </div>
              <div className="text-xs">
                <span className="text-gray-500">Language:</span>
                <span className="ml-1 font-medium">{scenario.demographics.primaryLanguage}</span>
              </div>
            </div>
            ...
            <div className="border-t pt-3">
              <div className="text-xs text-gray-500 mb-2">Learning Objectives:</div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-96 overflow-y-auto p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-2">All Learning Objectives:</h4>
