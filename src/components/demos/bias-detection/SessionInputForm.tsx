...
import type { SessionData, Demographics } from '../../../lib/types/bias-detection'
  ...
  return (
    <form onSubmit={handleSubmit} className="session-input-form space-y-4">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h5 className="font-medium text-blue-900 mb-2">Example Content Types:</h5>
        <ul className="text-sm text-blue-800 space-y-1">
          ...
          <li>• Assessment questions that could contain cultural assumptions</li>
          <li>• Intervention strategies that may not be culturally appropriate</li>
        </ul>
      </div>
      ...
      {formData.content.length > 800 && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
          <div className="flex">
            ...
            <div>
              <h4 className="text-sm font-medium text-yellow-800">Long Content Notice</h4>
              <p className="text-sm text-yellow-700 mt-1">
                Very long content may take longer to analyze and could affect accuracy.
              </p>
            </div>
          </div>
        </div>
