 ...
 */
export function validateHIPAAEnvironment(): { valid: boolean; missing: string[] } {
...
export type RiskLevel = typeof HIPAA_SECURITY_CONFIG.RISK_LEVELS[keyof typeof HIPAA_SECURITY_CONFIG.RISK_LEVELS]
export type KeyStatus = typeof HIPAA_SECURITY_CONFIG.KEY_STATUS[keyof typeof HIPAA_SECURITY_CONFIG.KEY_STATUS]