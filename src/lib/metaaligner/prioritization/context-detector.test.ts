...
import {
  ...
  getDefaultContextDetectorConfig,
...
describe('ContextDetector', () => {
  ...
  describe('detectContext', () => {
    ...
    describe('context classification', () => {
                  ...
                  contextualIndicators: [
                    {
                      ...
                      description: 'Expressing feelings of sadness',
                      confidence: 0.8,
                    },
                  ],
                  needsSpecialHandling: false,
      ...
      it('should detect clinical assessment context', async () => {
                  ...
                  contextualIndicators: [
                    {
                      ...
                      description: 'Asking about symptoms for diagnosis',
                      confidence: 0.9,
                    },
                  ],
        ...
        const result = await contextDetector.detectContext(
          'Do I have depression? I have these symptoms...',
        )
                  ...
                  contextualIndicators: [
                    {
                      ...
                      description: 'Requesting information about resources',
                      confidence: 0.8,
                    },
                  ],
                  needsSpecialHandling: false,
    ...
    describe('conversation history integration', () => {
      it('should include conversation history in analysis', async () => {
        ...
        await contextDetector.detectContext(
          'Can you help me?',
          conversationHistory,
        )
    ...
    describe('error handling', () => {
      ...
      it('should handle crisis service errors gracefully', async () => {
        mockCrisisDetectionService.detectCrisis.mockRejectedValue(
          new Error('Crisis service error'),
        )
  ...
  describe('createAlignmentContext', () => {
    it('should create properly structured alignment context', () => {
      ...
      expect(alignmentContext.sessionMetadata?.contextDetection).toBe(
        detectionResult,
      )
