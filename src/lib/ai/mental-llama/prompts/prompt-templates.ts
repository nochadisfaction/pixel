...
export function buildGeneralAnalysisPrompt(params: FiveTierPromptParams): Message[] {
...
export const specializedPrompts = {
  ...
  stress: (text: string) => buildGeneralAnalysisPrompt({ text, categoryHint: 'stress' }),
  wellness: (text: string) => buildGeneralAnalysisPrompt({ text, categoryHint: 'wellness' }),
  interpersonal_risk: (text: string) => buildGeneralAnalysisPrompt({ text, categoryHint: 'interpersonal_risk' }),
