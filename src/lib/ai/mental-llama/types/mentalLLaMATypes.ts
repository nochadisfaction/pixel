...
export interface IPythonBridge {
  ...
  callFunction(moduleName: string, functionName: string, args?: unknown[]): Promise<unknown>;
  isAvailable(): Promise<boolean>;
...
export interface RoutingDecision {
  ...
  method: 'keyword' | 'llm' | 'contextual_rule' | 'explicit_hint' | 'default' | 'keyword_fallback' | 'context_fallback' | 'default_fallback'; // How was this decision made?
  ...
  failureInfo?: {
    errorType: 'llm_error' | 'parsing_error' | 'timeout' | 'invalid_input' | 'network_error' | 'unknown_error';
    errorMessage: string; // Human-readable error description
    errorCode?: string; // Machine-readable error code
...
export interface AnalysisFailure {
  type: 'crisis_notification' | 'session_flagging' | 'model_analysis' | 'routing' | 'general';
  message: string;
  timestamp: string;
  ...
  failureInfo?: {
    ...
    errorType: 'model_error' | 'parsing_error' | 'timeout' | 'invalid_response' | 'network_error' | 'validation_error' | 'unknown_error';
    errorMessage: string; // Human-readable error description
    errorCode?: string; // Machine-readable error code
...
export interface LLMRoutingResponse {
  ...
  failureInfo?: {
    errorType: 'model_unavailable' | 'response_malformed' | 'timeout' | 'rate_limited' | 'content_filtered' | 'unknown_error';
