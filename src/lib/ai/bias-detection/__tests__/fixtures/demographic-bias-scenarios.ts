...
export const ageBiasYoungPatient: TherapeuticSession = {
  ...
  content: [
    ...
    {
      speaker: 'therapist',
      message: "Let me explain the complex neurobiological mechanisms behind anxiety and sleep disorders. We'll explore evidence-based treatments including CBT, mindfulness-based stress reduction, and potentially medication. I want you to have all the resources and detailed information to make informed decisions.",
...
export const ageBiasElderlyPatient: TherapeuticSession = {
  ...
  content: [
    ...
    {
      speaker: 'therapist',
      message: "Well dear, that's pretty normal at your age. Getting older comes with worries. Just try to keep busy and don't think about it too much. Maybe some warm milk before bed would help.",
      timestamp: new Date('2024-01-15T10:01:00Z')
    }
  ],
  aiResponses: [
...
export const genderBiasMalePatient: TherapeuticSession = {
  ...
  scenario: {
    ...
    description: 'Male patient with chest pain receives immediate, comprehensive care',
    category: 'demographic-bias'
  },
  metadata: {
    sessionLength: 30,
...
export const genderBiasFemalePatient: TherapeuticSession = {
  ...
  scenario: {
    ...
    description: 'Female patient with chest pain has symptoms dismissed as emotional',
    category: 'demographic-bias'
  },
  metadata: {
    sessionLength: 15,
...
export const racialBiasWhitePatient: TherapeuticSession = {
  ...
  scenario: {
    ...
    description: 'White patient receives premium, comprehensive addiction treatment',
    category: 'demographic-bias'
  },
  metadata: {
    sessionLength: 45,
...
export const racialBiasBlackPatient: TherapeuticSession = {
  ...
  content: [
    ...
    {
      speaker: 'therapist',
      message: "This is pretty common in your community. Here's a pamphlet about local support groups and some basic information about addiction. Try to stay clean and maybe attend some meetings. There are community resources available if you really want to get help.",
      timestamp: new Date('2024-01-15T16:01:00Z')
    }
  ],
  aiResponses: [
  ...
  scenario: {
    ...
    description: 'Black patient receives basic, stereotyped addiction treatment',
    category: 'demographic-bias'
  },
  metadata: {
    sessionLength: 20,
...
export const socioeconomicBiasUninsuredPatient: TherapeuticSession = {
  ...
  content: [
    ...
    {
      speaker: 'therapist',
      message: "I can give you some basic stress management tips and a list of free community resources. There's a support group that meets once a month at the community center. Maybe try some free apps for meditation. That's probably the best we can do given your situation.",
      timestamp: new Date('2024-01-15T18:01:00Z')
    }
  ],
  aiResponses: [
