...
vi.mock('astro:env/server', () => ({
  REDIS_URL: process.env['REDIS_URL'] || 'rediss://default:AS3JAAIjcDFlOGQ0YWIzOGYxYmU0MDU3YTlmZGFmYjI1NjQ1OGUwZHAxMA@neutral-ray-11721.upstash.io:6379',
  UPSTASH_REDIS_REST_URL: process.env['UPSTASH_REDIS_REST_URL'] || 'https://neutral-ray-11721.upstash.io',
  UPSTASH_REDIS_REST_TOKEN: process.env['UPSTASH_REDIS_REST_TOKEN'] || 'AS3JAAIjcDFlOGQ0YWIzOGYxYmU0MDU3YTlmZGFmYjI1NjQ1OGUwZHAxMA',
  NODE_ENV: 'test',
  DATABASE_URL: process.env['DATABASE_URL'] || 'postgresql://postgres:I7iOlqwkCiIDVoNQ@db.dihivzkwbwpkpebichlk.supabase.co:5432/postgres',
}))
