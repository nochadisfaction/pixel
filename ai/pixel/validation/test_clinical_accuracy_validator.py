...
class TestClinicalAccuracyValidator:
    ...
    async def test_dsm5_assessment_comorbid(self, validator, sample_context):
        ...
        assert len(dsm5_result.secondary_diagnoses) > 0 or "anxiety" in dsm5_result.primary_diagnosis.lower()
    ...
    @pytest.mark.asyncio
    async def test_therapeutic_appropriateness_cultural_sensitivity(self, validator, sample_context):
        ...
        therapeutic_result = await validator._assess_therapeutic_appropriateness(response, sample_context)
    ...
    def test_calculate_overall_accuracy_excellent(self, validator):
        ...
        accuracy, confidence = validator._calculate_overall_accuracy(dsm5, pdm2, therapeutic, safety)
