...
class TestTrainingState:
    ...
    def test_training_state_creation(self):
        ...
        model_state = {"linear.weight": torch.randn(1, 10), "linear.bias": torch.randn(1)}
    ...
    def test_training_state_with_optional_fields(self):
        ...
        assert training_state.loss_weights == {"language": 0.5, "eq": 0.3, "clinical": 0.2}
...
class TestCheckpointManager:
    ...
    def test_save_and_load_checkpoint(self):
        ...
        checkpoint_id = self.manager.save_checkpoint(
            training_state,
            metrics={"loss": 0.5, "validation_loss": 0.3},
            is_best=True
        )
